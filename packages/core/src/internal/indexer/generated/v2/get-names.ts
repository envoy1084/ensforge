...
export type V2GetNamesQueryVariables = Exact<{
  first: number;
...
export const V2GetNamesDocument =
  "query V2GetNames($first: Int!, $after: String, $where: DomainFilter, $orderBy: Domain_orderBy!, $orderDirection: OrderDirection!) {\n  _meta {\n    block {\n      number\n    }\n  }\n  domainConnection(\n    first: $first\n    after: $after\n    where: $where\n    orderBy: $orderBy\n    orderDirection: $orderDirection\n  ) {\n    edges {\n      cursor\n      node {\n        ...V2IndexedNameFields\n      }\n    }\n    pageInfo {\n      hasNextPage\n      endCursor\n    }\n  }\n}\n\nfragment V2IndexedNameFields on Domain {\n  id\n  protocol\n  name\n  labelName\n  labelhash\n  parent {\n    id\n    subregistry {\n      address\n    }\n  }\n  owner {\n    id\n  }\n  registrant {\n    id\n  }\n  resolvedAddress {\n    id\n  }\n  resolver {\n    address\n  }\n  createdAt\n  expiryDate\n  subdomainCount\n  isMigrated\n  ttl\n  wrappedOwner {\n    id\n  }\n  wrappedDomain {\n    owner {\n      id\n    }\n    fuses\n    expiryDate\n  }\n  subregistry {\n    address\n  }\n  canonicalId\n  tokenId\n  tokenVersion\n  registrationDate\n  gracePeriodEnd\n  unreachableSince\n  isNormalized\n  isReachable\n  isWrapped\n  roleHolderCount\n}" as TypedDocumentString<
    V2GetNamesQuery,
    V2GetNamesQueryVariables
  >;
