...
export type V1GetRecordHistoryQueryVariables = Exact<{
  first: number;
  skip: number;
...
export type V1GetRecordHistoryQuery = {
  ...
  readonly resolverEvents: ReadonlyArray<
    | {
        ...
        readonly resolver: { readonly id: string; readonly address: `0x${string}` };
      }
    | {
...
export const V1GetRecordHistoryDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "V1GetRecordHistory" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<V1GetRecordHistoryQuery, V1GetRecordHistoryQueryVariables>;
