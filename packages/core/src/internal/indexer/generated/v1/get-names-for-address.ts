...
export type V1GetNamesForAddressQueryVariables = Exact<{
  first: number;
  skip: number;
  where: Domain_Filter;
}>;

export type V1GetNamesForAddressQuery = {
...
export const V1GetNamesForAddressDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "V1GetNamesForAddress" },
      variableDefinitions: [
        {
        ...
        },
        {
          ...
          type: {
            kind: "NonNullType",
            type: { kind: "NamedType", name: { kind: "Name", value: "Domain_filter" } },
          },
        },
      ],
      selectionSet: {
...
} as unknown as DocumentNode<V1GetNamesForAddressQuery, V1GetNamesForAddressQueryVariables>;
