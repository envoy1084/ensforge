...
export type V1GetNamesQueryVariables = Exact<{
  first: number;
...
export const V1GetNamesDocument = {
  kind: "Document",
  definitions: [
    {
      kind: "OperationDefinition",
      operation: "query",
      name: { kind: "Name", value: "V1GetNames" },
      variableDefinitions: [
        {
...
} as unknown as DocumentNode<V1GetNamesQuery, V1GetNamesQueryVariables>;
