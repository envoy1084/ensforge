/**
 * Complete UniversalResolver ABI from @ensdomains/ens-contracts v1.7.0.
 * Source: contracts/universalResolver/UniversalResolver.sol
 */
export const universalResolverV1Abi = [
  {
    inputs: [
      {
