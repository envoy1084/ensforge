/**
 * Complete NameWrapper ABI from @ensdomains/ens-contracts v1.7.0.
 * Source: .repos/ens-contracts-v1/deployments/mainnet/NameWrapper.json
 */
export const nameWrapperV1Abi = [
  {
    inputs: [
      {
