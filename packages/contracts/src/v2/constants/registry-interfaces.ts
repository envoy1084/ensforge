...
export const registryInterfaceIds = {
  ...
  /** Permissioned Registry interface deployed by the public `sepolia-v2` release. */
  permissionedRegistrySepolia: "0x6be50c69",
  standardRegistry: "0xb844ab6c",
  temporalRegistry: "0x6f537c72",
  tokenizedRegistry: "0x91b3c037",
  wrapperRegistry: "0xf5586a0b",
  /** Wrapper Registry interface deployed by the public `sepolia-v2` release. */
  wrapperRegistrySepolia: "0xe01aaa11",
} as const;
