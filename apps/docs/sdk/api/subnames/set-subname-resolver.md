...
const result = await ens.subnames.setSubnameResolver({
...
const program = ens.subnames.setSubnameResolver.effect(parameters);
...
```ts
const call = ens.subnames.setSubnameResolver.call(parameters);
```
