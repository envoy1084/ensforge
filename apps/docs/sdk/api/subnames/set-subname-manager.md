...
const result = await ens.subnames.setSubnameManager({
...
const program = ens.subnames.setSubnameManager.effect(parameters);
...
```ts
const call = ens.subnames.setSubnameManager.call(parameters);
```
