...
const result = await ens.reverse.clearPrimaryName({});
```
...
const program = ens.reverse.clearPrimaryName.effect(parameters);
...
```ts
const call = ens.reverse.clearPrimaryName.call(parameters);
```
