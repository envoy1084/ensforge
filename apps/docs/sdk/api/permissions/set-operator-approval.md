...
const result = await ens.permissions.setOperatorApproval({
  name: "example.eth",
...
const program = ens.permissions.setOperatorApproval.effect(parameters);
...
```ts
const call = ens.permissions.setOperatorApproval.call(parameters);
```
