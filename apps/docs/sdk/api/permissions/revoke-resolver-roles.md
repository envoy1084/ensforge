...
const program = sdk.permissions.revokeResolverRoles.effect(parameters);
...
```ts
const call = sdk.permissions.revokeResolverRoles.call(parameters);
```

## Error

```ts
import type { RevokeResolverRolesError } from "@ensforge/sdk/permissions";
```
