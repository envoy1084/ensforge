...
const program = sdk.permissions.grantResolverRootRoles.effect(parameters);
...
```ts
const call = sdk.permissions.grantResolverRootRoles.call(parameters);
```

## Error

```ts
import type { GrantResolverRootRolesError } from "@ensforge/sdk/permissions";
```
