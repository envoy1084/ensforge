...
const result = await ens.wrapping.extendSubnameExpiry({
  name: "example.eth",
...
const program = ens.wrapping.extendSubnameExpiry.effect(parameters);
...
```ts
const call = ens.wrapping.extendSubnameExpiry.call(parameters);
```
