...
```ts
import { trustedHcaSetV2Abi } from "@ensforge/contracts/v2/experimental/hca";
```
...
| Export               | Description                                             |
| -------------------- | ------------------------------------------------------- |
| `trustedHcaSetV2Abi` | Immutable ABI value with viem-compatible literal types. |
...
```ts
type Export = typeof trustedHcaSetV2Abi;
```
