...
# Standalone HCA Factory Interface
...
```ts
import { standaloneHcaFactoryV2InterfaceAbi } from "@ensforge/contracts/v2/experimental/hca";
```
...
const contract = getContract({
  address,
  abi: standaloneHcaFactoryV2InterfaceAbi,
  client: publicClient,
});
```
...
| Export                               | Description                                             |
| ------------------------------------ | ------------------------------------------------------- |
| `standaloneHcaFactoryV2InterfaceAbi` | Immutable ABI value with viem-compatible literal types. |
...
```ts
type Export = typeof standaloneHcaFactoryV2InterfaceAbi;
```
